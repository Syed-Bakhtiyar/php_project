    ...
    if (!isset($_POST['mobile_no']) || trim($_POST['mobile_no']) == "") {
		...
		//if($otp_db == $_POST['otp']){
			...
			if($rowcount_user_id > 0){
				...
				$response = array("status" => "success", "error_message" => "", "success_message" => "Otp verify successfull", "data" => array('mobile_number'=>$_POST['mobile_no'],'id'=>$id));
			}else{
				$sql2insert_mob = "INSERT INTO user_tbl(`userid`) VALUES('".$newmob."') ";
